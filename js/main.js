...
const GUEST_REGISTRY = {
  ...
  "REVVII": { name: "Venky" },
  "REVVIII": { name: "Saharsh Vuppula" },
  "REVIX": { name: "Aradhya Kadiri" },
  "REVX": { name: "Abhijeet Raj Nalla" },
  ...
  "REVXVI": { name: "Aiheka Gadde" },
  "REVXVII": { name: "Nagesh Pebbati" },
  "REVXVIII": { name: "Rahul Cheruku" },
  "REVXIX": { name: "Sai Sohan Dasi" },
  ...
  "REVXXXI": { name: "Dr. Sunil Bhutada" },
  "REVXXXII": { name: "Dr. P. Venkat Praveen" },
  "REVXXXIII": { name: "Dr. Chitumodhu Bhargava" },
  "REVXXXIV": { name: "Dr. D. Paramesh" },
  "REVXXXV": { name: "Mr. Vasudeva Rao" },
  "REVXXXVI": { name: "Dr. Preethi Jeevan" },
...
function syncTaglineFromDOM() {
  ...
  if (guestDisplay) {
    ...
    } else if (currentName.includes('akshay') || currentName.includes('nanda kishore')) {
